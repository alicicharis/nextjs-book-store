...
export default async function DashboardPage() {
  const [
    ...
    db
      ...
      .select([db.fn.count("order_items.id").as("count")])
      .execute(),
    db
      .selectFrom("customers")
      .select([db.fn.count("customers.id").as("count")])
      .execute(),
    db
      .selectFrom("orders")
      .select([db.fn.sum("orders.total_price").as("total_revenue")])
      .execute(),
    db
      .selectFrom("orders")
